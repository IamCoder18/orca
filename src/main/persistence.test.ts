...
describe('Store', () => {
  ...
  it('returns default settings when no data file exists', async () => {
    ...
    expect(settings.visibleTaskProviders).toEqual(['github', 'gitlab', 'linear', 'jira', 'huly'])
  ...
  it('merges loaded data with defaults for missing fields', async () => {
    ...
    expect(store.getSettings().visibleTaskProviders).toEqual(['github', 'gitlab', 'linear', 'jira', 'huly'])
  ...
  it('normalizes malformed visible task providers on load', async () => {
    ...
    const store = await createStore()
    expect(store.getSettings().visibleTaskProviders).toEqual(['gitlab', 'jira', 'huly'])
  })
  ...
  it('repairs drifted task provider defaults on load', async () => {
    ...
    expect(store.getSettings().visibleTaskProviders).toEqual(['github', 'linear', 'jira', 'huly'])
  })
