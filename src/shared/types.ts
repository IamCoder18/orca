...
export type GlobalSettings = {
  ...
  /** Why: one-shot guard to make Huly visible for existing profiles once, without re-adding after a later opt-out. */
  visibleTaskProvidersDefaultedForHuly: boolean
